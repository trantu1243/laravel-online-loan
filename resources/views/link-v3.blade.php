...
<head>
  ...
  <script>(function (w, d, s, l, i) {
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-MW8BDMQ8');</script>
  ...
  <link rel="stylesheet" href="/js/dist/bootstrap.min.css" />
  <meta property="og:url" content="vay.lottefinance.vn" />
  <meta property="og:title" content="LFVN - Loan" />
  <meta property="og:type" content="website" />
  <meta property="og:description" content="LFVN - Loan" />
  ...
  <style id="style_page" type="text/css">
    ...
    @font-face {
      font-family: "RmudHNGcmVlLUldCTRlBybRpcBsYXktTWVkaXVtLnRZg";
      src: url("/ladi/fontsfree-net-sfprodisplay-medium-20240219081708-bmy2-.ttf") format("truetype");
    }
  ...
  <style id="style_element" type="text/css">
    ...
    #BUTTON_TEXT43>.ladi-headline:hover,
    ...
    #PARAGRAPH181>.ladi-paragraph:hover,
    ...
    #PARAGRAPH144>.ladi-paragraph:hover,
    #PARAGRAPH148>.ladi-paragraph:hover,
    #PARAGRAPH146>.ladi-paragraph:hover,
    ...
    #PARAGRAPH199>.ladi-paragraph:hover,
    ...
    #BUTTON43.ladi-animation>.ladi-button,
    #IMAGE143.ladi-animation>.ladi-image {
    ...
    #FORM10 .ladi-form .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item span[data-checked="false"],
    #FORM10 .ladi-form .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item .ladi-editing,
    #FORM10 .ladi-form .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item .ladi-editing::placeholder,
    ...
    #FORM12 .ladi-form-item-container .ladi-form-item .ladi-form-control-select {
      background-image: url("data:image/svg+xml;utf8, %3Csvg%20width%3D%2232%22%20height%3D%2224%22%20viewBox%3D%220%200%2032%2024%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%3E%3Cpolygon%20points%3D%220%2C0%2032%2C0%2016%2C24%22%20style%3D%22fill%3A%20rgb(111%2C%20108%2C%20108)%22%3E%3C%2Fpolygon%3E%3C%2Fsvg%3E");
    }
    ...
    #FORM_ITEM701 .ladi-form-checkbox-item,
    #FORM_ITEM7011 .ladi-form-checkbox-item,
    #FORM_ITEM10 .ladi-form-checkbox-item,
    #FORM_ITEM101 .ladi-form-checkbox-item,
    #FORM_ITEM1011 .ladi-form-checkbox-item,
    #FORM_ITEM54 .ladi-form-checkbox-item,
    #FORM_ITEM66 .ladi-form-checkbox-item {
      margin-top: 5px;
      margin-bottom: 5px;
      margin-left: 5px;
      margin-right: 10px !important;
    ...
    #FORM_ITEM70 .ladi-form-item.ladi-form-checkbox {
      padding-top: 5px;
      padding-bottom: 5px;
    }
    ...
    #FORM_ITEM66 .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item input,
    #FORM_ITEM70 .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item input {
      width: 13px;
      height: 13px;
    }
    ...
    #FORM_ITEM70 .ladi-form-item.ladi-form-checkbox .ladi-form-checkbox-item span {
      width: calc(100% - 17px);
    }
    ...
    #IMAGE153>.ladi-image>.ladi-image-background,
    #IMAGE157>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/icon-info-20240314060712-mtept.png");
    }
    ...
    #IMAGE78>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/coin3x-1-20240216094817-t9mkf.png");
    }

    #IMAGE79>.ladi-image>.ladi-image-background,
    #IMAGE149>.ladi-image>.ladi-image-background,
    #IMAGE156>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/group-122-20240219035036-emdxm.png");
    }

    #BOX32>.ladi-box,
    #BOX41>.ladi-box {
      box-shadow: rgb(0, 0, 0) 0px 5px 20px -15px;
    }
    ...
    #BOX9>.ladi-box,
    #BOX8>.ladi-box {
      box-shadow: rgb(0, 0, 0) 4px 4px 20px -15px;
    }
    ...
    #LINE41>.ladi-line>.ladi-line-container {
      ...
      border-right: 1px solid rgb(211, 211, 212);
      border-bottom: 1px solid rgb(211, 211, 212);
      border-left: 1px solid rgb(211, 211, 212);
    }
    ...
    #CAROUSEL1 .ladi-carousel .ladi-carousel-arrow {
      background-image: url("data:image/svg+xml;utf8, %3Csvg%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20fill%3D%22rgba(244%2C%2064%2C%2037%2C%201)%22%3E%3Cpath%20fill-rule%3D%22evenodd%22%20clip-rule%3D%22evenodd%22%20d%3D%22M7.00015%200.585938L18.4144%2012.0002L7.00015%2023.4144L5.58594%2022.0002L15.5859%2012.0002L5.58594%202.00015L7.00015%200.585938Z%22%3E%3C%2Fpath%3E%3C%2Fsvg%3E");
    }
    ...
    #IMAGE48>.ladi-image>.ladi-image-background,
    #IMAGE145>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/group-39877-20240216101201-hcri4.png");
    }
    ...
    #IMAGE73>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/frame-7-20240313113510-pk7x3.png");
    }
    ...
    #IMAGE75>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/group-5-20240216094840-1ksqd.png");
    }
    ...
    #IMAGE72>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/frame-4-20240216094817-cpugp.png");
    }
    ...
    #IMAGE74>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/facebook_messenger_logo_2018-1-20240216094817-ckct0.png");
    }
    ...
    #LINE73>.ladi-line>.ladi-line-container,
    #LINE71>.ladi-line>.ladi-line-container,
    #LINE69>.ladi-line>.ladi-line-container,
    #LINE76>.ladi-line>.ladi-line-container,
    #LINE75>.ladi-line>.ladi-line-container,
    #LINE74>.ladi-line>.ladi-line-container,
    #LINE72>.ladi-line>.ladi-line-container {
      border-top: 2px solid rgb(211, 211, 212);
      border-right: 2px solid rgb(211, 211, 212);
      border-bottom: 2px solid rgb(211, 211, 212);
      border-left: 0px !important;
    }
    ...
    #IMAGE132>.ladi-image>.ladi-image-background,
    #IMAGE137>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/frame-6-20240216094817-d2bsb.png");
    }
    ...
    #IMAGE133>.ladi-image>.ladi-image-background,
    #IMAGE138>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/group-3-20240216094840-lgf_t.png");
    }
    ...
    #IMAGE134>.ladi-image>.ladi-image-background,
    #IMAGE139>.ladi-image>.ladi-image-background {
      background-image: url("/ladi/vector-20240216094846-xj9jm.png");
    }
    ...
    @media (min-width: 768px) {
      ...
      #IMAGE53>.ladi-image>.ladi-image-background {
        background-image: url("{{ $setting->about_image }}");
      }
    ...
    @media (max-width: 767px) {
      ...
      #SECTION2>.ladi-section-background {
        background-image: url("/ladi/kv-vay-nhanh-lai-canh-tranh-1000x310-02-1-20240219040248-06k2t.png");
      }
      ...
      #IMAGE53>.ladi-image>.ladi-image-background {
        background-image: url("/ladi/c8b000ef-1-20240216094817-wjf-r.png");
      }
...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MW8BDMQ8" height="0" width="0"
      style="display:none;visibility:hidden"></iframe></noscript>
  <!-- End Google Tag Manager (noscript) -->
  <!-- Google Tag Manager (noscript) -->
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-N2B98J96" height="0" width="0"
      style="display:none;visibility:hidden"></iframe></noscript>
  <!-- End Google Tag Manager (noscript) -->

  <svg xmlns="http://www.w3.org/2000/svg"
    style="width: 0px; height: 0px; position: absolute; overflow: hidden; display: none;">
    <symbol id="shape_JPJeNRfroa" viewBox="0 0 24 24">
      <path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z"></path>
    </symbol>
    <symbol id="shape_EuvqYgIJeu" viewBox="0 0 24 24">
  ...
  <div class="ladi-wraper">
    <div id="SECTION1" class='ladi-section'>
      ...
      <div class="ladi-container">
        ...
        <div data-action="true" id="HEADLINE8" class='ladi-element'>
          <h1 class='ladi-headline ladi-transition'>Q&amp;A</h1>
        </div>
                    ...
                    <div id="GROUP102" class='ladi-element'>
                      <div class='ladi-group'>
                        <div id="FORM2" data-config-id="" class='ladi-element'>
                          <form action="{{ Route('post-update-v2', ['token' => $token]) }}" autocomplete="off" method="POST" class='ladi-form' id="FORM_TEXT25" enctype="multipart/form-data">
                                @csrf
                              <div id="FORM_ITEM2" class='ladi-element'>
                                <div class="ladi-form-item-container">
                                  <div class="ladi-form-item-background"></div>
                                  <div class='ladi-form-item'><input autocomplete="off" tabindex="1" name="frontCCCD" required
                                      class="ladi-form-control" type="file" placeholder="Chọn ảnh" value="" /></div>
                                </div>
                              </div>
                              <div id="FORM_ITEM4" class='ladi-element'>
                                <div class="ladi-form-item-container">
                                  <div class="ladi-form-item-background"></div>
                                  <div class='ladi-form-item'><input autocomplete="off" tabindex="2" name="backCCCD" required
                                      class="ladi-form-control" type="file" placeholder="Chọn ảnh"
                                      value="" /></div>
                                </div>
                              </div>
                                ...
                                <div class="ladi-form-item-container">
                                  ...
                                  <div class='ladi-form-item'>
                                      ...
                                      <div class="placehorder">
                                        <p class="text-camera" style="display: inline;">Not taken</p>
                                        <svg style="color: green; display: none;" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                          fill="currentColor" class="bi bi-check-circle check-icon" viewBox="0 0 16 16">
                        ...
                        <div id="PARAGRAPH70" class='ladi-element'>
                          <div class='ladi-paragraph'>CCCD mặt trước<span style="color: rgb(231, 37, 43);">*</span></div>
                        </div>
                        <div id="PARAGRAPH71" class='ladi-element'>
                          <div class='ladi-paragraph'>CCCD mặt sau<span style="color: rgb(231, 37, 43);">*</span></div>
                        </div>
                        <div id="PARAGRAPH72" class='ladi-element'>
                          <div class='ladi-paragraph'>Bảng lương<span style="color: rgb(231, 37, 43);">*</span></div>
                        </div>
    ...
    <div id="SECTION13" class='ladi-section'>
      <div class='ladi-section-background'></div>
      <div class="ladi-container">
        <div data-action="true" id="GROUP196" class='ladi-element'>
          <div class='ladi-group'>
                        ...
                        <div id="GROUP110" class='ladi-element'>
                          <div class='ladi-group'>
                            ...
                            <div id="PARAGRAPH79" class='ladi-element'>
                              <div class='ladi-paragraph'>Mặt trước CCCD<span style="color: rgb(231, 37, 43);">*</span></div>
                            </div>
                            <div id="PARAGRAPH80" class='ladi-element'>
                              <div class='ladi-paragraph'>Mặt sau CCCD<span style="color: rgb(231, 37, 43);">*</span>
                              </div>
                            </div>
                            <div id="PARAGRAPH81" class='ladi-element'>
                              <div class='ladi-paragraph'>Bảng lương<span style="color: rgb(231, 37, 43);">*</span>
                              </div>
                            </div>
    ...
    <div id="SECTION8" class='ladi-section'>
      ...
      <div class="ladi-container">
        ...
        <div id="GROUP26" class='ladi-element'>
          <div class='ladi-group'>
            <div id="HEADLINE18" class='ladi-element'>
              <h1 class='ladi-headline ladi-transition'>Giới thiệu công ty</h1>
            </div>
        ...
        <div id="PARAGRAPH26" class='ladi-element'>
          <div class='ladi-paragraph ladi-transition'>{{ $setting->about1 }}</div>
        </div>
        ...
        <div id="PARAGRAPH179" class='ladi-element'>
          <div class='ladi-paragraph ladi-transition'>{{ $setting->about2 }}</div>
        </div>
      </div>
    </div>
    <div id='SECTION11' class='ladi-section'>
        ...
        <div class='ladi-container'>
          ...
          <div data-action='true' id='GROUP89' class='ladi-element'>
            <div class='ladi-group'><a href='tel:{{ $setting->hotline }}' id='GROUP87' class='ladi-element' title='Hotline đăng ký vay'>
                <div class='ladi-group'>
              ...
              </a><a href='{{ $setting->link_mes }}' target='_blank' id='GROUP88'
                class='ladi-element'>
                <div class='ladi-group'>
            ...
            <div class="col-12 col-md-12 col-lg-12">
              <div class="card bg-white mb-3 mt-3 border-0" style="box-shadow: 0 12px 15px rgba(0, 0, 0, 0.02);">
                <div class="card-body">
                  ...
                  <canvas id="canvas" width="640" height="480" style="display: none; width: 100%;"></canvas>
                  <div class="text-center">
                    <div class="btn button-gardient mt-5 form-control" id="capture">
                      Chụp
                    </div>
                    <div class="btn button-gardient mt-5 form-control" id="confirm-image" style="display: none;">
                      Xác nhận
                    </div>
                  </div>
                </div>
  ...
  <script id="jquery" type="text/javascript">/*! jQuery v3.7.1 | (c) OpenJS Foundation and other contributors | jquery.org/license */
  ...
  <script type="text/javascript" src="/js/dist/sweetalert.js"></script>
  <script type="text/javascript" src="/js/dist/bootstrap.min.js"></script>
  <script type="text/javascript" src="/js/dist/bootstrap.bundle.min.js"></script>
  ...
  <script>
    const startCaptureButtons = document.querySelectorAll('.startCapture');

    const modalNoti = new bootstrap.Modal(document.getElementById("modalNoti"));
    ...
    const textElements = document.querySelectorAll('.text-camera');
    const iconElements = document.querySelectorAll('.check-icon');

    startCaptureButtons.forEach(button => {
...
<!--Publish time: Tue, 26 Mar 2024 07:40:16 GMT-->
<!--LadiPage build time: Mon, 25 Mar 2024 07:07:08 GMT-->
